...
main.iconbitmap('D:/PROJECT/images/photo.jpg')

main.geometry("500x600")

file = PhotoImage(
    file='D:/PROJECT/images/photo.png')
...
dBtn = Button(main, text="Start Download", font=(
    "Times New Roman", 14), relief='ridge', activeforeground='red', command=startDownloadthread)
dBtn.pack(side=TOP)
label = Label(main, text='')
desc = Label(main, text='')
author = Label(main, text="YT DOWNLOADER")
